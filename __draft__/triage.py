...
def triage_biopsy(core1_length: float = 0, core1_cortex: bool = False, core2_length: float = 0, core2_cortex: bool = False,
                  core3_length: float = 0, core3_cortex: bool = False, n_passes: int = 0):
